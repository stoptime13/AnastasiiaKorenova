...
public class ActionStep extends AbstractStep {
    ...
    @When("I select {string} checkboxes in main form on Different Elements page")
    public void clickCheckboxDiffEl(String checkbox) {
        diffElement.clickCheckbox(checkbox);
    }

    @When("I select radio buttons {string} in main form on Different Elements page")
    public void clickRadioboxDiffEl(String radiobox) {
        diffElement.clickRadiobox(radiobox);
    }

    @When("I select {string} in dropdown in main form on Different Elements page")
